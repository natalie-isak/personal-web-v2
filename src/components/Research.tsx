...
const publications = [
  ...
  },
  {
    ...
    date: "February 2025",
    description: <>System for designing and managing conversational AI artifacts with guardrails. Try it out in <a href="https://github.com/microsoft/semantic-kernel/tree/main/python/samples/demos/guided_conversations">Github</a>.</>,
    icon: "patent",
  },
  {
    type: "Patent",
